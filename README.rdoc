...
* There is one bug that I was not able to resolve before the deadline. Clicking on the "CoderCola" logo in the header
  opens up the home page, and at the same time seems to break the javascript. I have a strong suspicion that this may be
  caused by Turbolinks